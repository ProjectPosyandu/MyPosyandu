...
//    private int id_bayi;
    private String id_jadwal,nama_imunisasi,tgl_imunisasi, waktu;

    public ModelDataJadwal(String id_jadwal, String nama_imunisasi, String tgl_imunisasi, String waktu) {
